...
<div class="android-content mdl-layout__content">
 ...
 <div class="container">
     <form method="post" action="editar2.php" enctype="multipart/form-data">
         ...
         $articulo=$_POST['id'];
         echo"
<input style='visibility:hidden' name='para' value='$seccion' >
<input style='visibility:hidden' name='metros' value='$articulo' >

";
?>
  <h1 style="padding-left: 35%;">Editar</h1>
    <p style="padding-left: 35%;">Por favor llena los datos correctamente para poder editar el producto.</p><br>
